...
void map_delete_K__V(Map_K__V* m);
V* map_get_K__V(Map_K__V* map, K key);
V map_get_else_K__V(Map_K__V* map, K key, V else_);
void map_grow_K__V(Map_K__V* m);
void map_put_K__V(Map_K__V* map, K key, V value);
